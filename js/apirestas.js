async function AI() {
  ...
  switch (nivel.toLowerCase()) {
    case "primero":
      mensajeBase = "Explícale a un niño de primero cómo hacer restas sencillas con números pequeños. Usa frases cortas, dibujos mentales, ejemplos como dulces o juguetes. Usa emojis solo cuando ayuden.";
      cifras = 1;
      break;
    case "segundo":
      mensajeBase = "Explícale a un niño de segundo cómo hacer restas de dos cifras. Evita textos largos. Usa un ejemplo claro, un truco fácil y algo de ánimo si se equivocó. Usa emojis solo cuando ayuden.";
      cifras = 2;
      break;
    case "tercero":
      mensajeBase = "Explícale a un niño de tercero cómo hacer restas de tres cifras. Menciona qué hacer si hay que pedir prestado. Solo un ejemplo claro. Evita textos largos. Usa emojis solo cuando ayuden.";
      cifras = 3;
      break;
    case "cuarto":
      mensajeBase = "Explícale a un niño de cuarto cómo hacer restas con muchos números. Usa un ejemplo con 3 o 4 cifras, pero mantén el mensaje corto y positivo. Usa emojis solo cuando ayuden.";
      cifras = 4;
      break;
    default:
      mensajeBase = "Explícale cómo hacer una resta de forma simple y alegre. Un ejemplo, palabras fáciles y emojis útiles.";
      cifras = 1;
      break;
  }

  //Aquí se arma el mensaje completo que se envía a la API
  const mensaje = `Contexto: Ahora explícale al niño de forma **corta, clara y alegre** cómo hacer restas, dependiendo de su nivel académico: ${nivel}, y con restas de hasta ${cifras} cifras.
