async function AI() {
  ...
  const mensaje = "Contexto: Este mensaje aparece en una app para niñ@s entre 4 y 8 años justo después de terminar ejercicios. Explícale cómo hacer una división usando palabras muy simples, emojis y un ejemplo fácil (como repartir cosas en partes iguales). No hagas la explicación larga, solo lo justo para que lo entienda bien. No uses género, habla de forma neutral y amigable como si fueras un personaje tierno que da ánimos.";
